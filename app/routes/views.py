...
def profile():
    ...
    return render_template(
        "profile.html", professors=professors, statements=statements
    )
...
def new_application():
    ...
    return render_template(
        ...
        form=form,
        url=url_for("main.new_application"),
    )
...
def edit_application(application_id):
    ...
    return render_template(
        ...
        item_type="Application",
        form=form,
        url=url_for("main.edit_application", application_id=application_id),
    )
...
def new_professor():
    ...
    return render_template(
        ...
        item_type="Professor",
        form=form,
        url=url_for("main.new_professor"),
    )
...
def edit_professor(professor_id):
    ...
    return render_template(
        ...
        item_type="Professor",
        form=form,
        url=url_for("main.edit_professor", professor_id=professor_id),
    )
...
def new_statement():
    ...
    if form.validate_on_submit():
        new_statement = Statement(
            name=form.name.data, statement=form.statement.data, user_id=current_user.id
        )
    ...
    return render_template(
        ...
        item_type="Statement",
        form=form,
        url=url_for("main.new_statement"),
    )
...
def edit_statement(statement_id):
    ...
    return render_template(
        ...
        item_type="Statement",
        form=form,
        url=url_for("main.edit_statement", statement_id=statement_id),
    )
